from schemas import AppointmentResponse, Doctor, DoctorResponse, MedicalRecordHistoryResponse, Patient, PatientResponse, Appointment, MedicalRecord, MedicalRecordResponse
